...
const startBtn = document.getElementById("starts"); //corrcted start id name
...
const validate = (key) => {
  ...
  errorCount++; //error count is incremented
  return false;
};
...
const gameOver = () => {
  ...
  const timeTaken = (finishTime - startTime); //removed 1000 divider
...
setInterval(() => {
  ...
  const timeSpent = (currentTime - startTime) ; //removed 1000 divider to get integer output
